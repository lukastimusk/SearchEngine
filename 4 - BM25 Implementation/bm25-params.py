...
def main():
    ...
    if len(sys.argv) != 6:
        ...
        print("Usage: python3 bm25-params.py <k1> <b> <index path> <queries file path> <results output path>")
        sys.exit(1)
    ...
    queries_file_path = sys.argv[4]
    results_output_path = sys.argv[5]
